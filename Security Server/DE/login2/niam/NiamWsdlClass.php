...
/**
 * NiamWsdlClass to communicate with SOAP service
 */
class NiamWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     * Option key to define WS url
     * @var string
     */
    const WSDL_WSURL = 'wsdl_wsurl';
    /**
     * Option key to define SSL version
     * @var string
     */
    const WSDL_SSLVERSION = 'wsdl_sslversion';
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'var/wsdltophp.com/storage/wsdls/1820eaa0153a13dc8d6d1795fb2d9920/wsdl.xml';
    /**
    ...
    /**
     * Constructor
     * @uses NiamWsdlClass::setLastError()
     * @uses NiamWsdlClass::initSoapClient()
     * @uses NiamWsdlClass::initInternArrayToIterate()
     * @uses NiamWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'NiamWsdlClass'))
            {
     ...
     * @uses NiamClassMap::classMap()
     * @uses NiamWsdlClass::getDefaultWsdlOptions()
     * @uses NiamWsdlClass::getSoapClientClassName()
     * @uses NiamWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('NiamClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = NiamClassMap::classMap();
...
//                 		)
//                 ));
//               $wdslOptions['stream_context']=$streamContext;                
     ...
     * If a class is named as {Niam}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('NiamSoapClient') && is_subclass_of('NiamSoapClient','SoapClient'))
            return 'NiamSoapClient';
        else {
 //           return 'SoapClient';
            mydebug('setting SoapClientCurl class');
            return 'SoapClientCurl';
        }
    }
    /**
     * Method returning all default options values
     * @uses NiamWsdlClass::WSDL_CACHE_WSDL
     * @uses NiamWsdlClass::WSDL_COMPRESSION
     * @uses NiamWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses NiamWsdlClass::WSDL_ENCODING
     * @uses NiamWsdlClass::WSDL_EXCEPTIONS
     * @uses NiamWsdlClass::WSDL_FEATURES
     * @uses NiamWsdlClass::WSDL_LOGIN
     * @uses NiamWsdlClass::WSDL_PASSWORD
     * @uses NiamWsdlClass::WSDL_SOAP_VERSION
     * @uses NiamWsdlClass::WSDL_STREAM_CONTEXT
     * @uses NiamWsdlClass::WSDL_TRACE
     * @uses NiamWsdlClass::WSDL_TYPEMAP
     * @uses NiamWsdlClass::WSDL_URL
     * @uses NiamWsdlClass::VALUE_WSDL_URL
     * @uses NiamWsdlClass::WSDL_USER_AGENT
     * @uses NiamWsdlClass::WSDL_PROXY_HOST
     * @uses NiamWsdlClass::WSDL_PROXY_PORT
     * @uses NiamWsdlClass::WSDL_PROXY_LOGIN
     * @uses NiamWsdlClass::WSDL_PROXY_PASSWORD
     * @uses NiamWsdlClass::WSDL_LOCAL_CERT
     * @uses NiamWsdlClass::WSDL_PASSPHRASE
     * @uses NiamWsdlClass::WSDL_AUTHENTICATION
     * @uses NiamWsdlClass::WSDL_SSL_METHOD
    ...
    {
        return array(
        			self::WSDL_WSURL =>null,
        			self::WSDL_SSLVERSION =>null,
     ...
     * @uses NiamWsdlClass::getSoapClient()
     * @uses NiamWsdlClass::getFormatedXml()
     ...
     * @uses NiamWsdlClass::getSoapClient()
     * @uses NiamWsdlClass::convertStringHeadersToArray()
...
/**
     ...
     * @uses NiamWsdlClass::getInternArrayToIterate()
     * @uses NiamWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses NiamWsdlClass::getInternArrayToIterateOffset()
     * @uses NiamWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses NiamWsdlClass::getInternArrayToIterateOffset()
     * @uses NiamWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @uses NiamWsdlClass::getAttributeName()
     * @uses NiamWsdlClass::__toString()
     * @uses NiamWsdlClass::_set()
     * @uses NiamWsdlClass::_get()
     * @uses NiamWsdlClass::setInternArrayToIterate()
     * @uses NiamWsdlClass::setInternArrayToIterateIsArray()
     * @uses NiamWsdlClass::setInternArrayToIterateOffset()
